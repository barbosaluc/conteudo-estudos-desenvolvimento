## 1.0 Básico
####  1.1 Algoritmo
Sequência finita de passos bem definidos para resolver um problema ou executar uma tarefa. É a base de todo programa de computador. Um algoritmo deve ser preciso, finito e eficaz.
